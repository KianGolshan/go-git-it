...
export class PanelWebviewProvider implements vscode.WebviewViewProvider {
  ...
  resolveWebviewView(view: vscode.WebviewView): void {
    ...
    view.webview.onDidReceiveMessage(
      (msg: { type: string; command?: string; hash?: string }) => {
        if (msg.type === 'command' && msg.command) this._onCommand(msg.command)
